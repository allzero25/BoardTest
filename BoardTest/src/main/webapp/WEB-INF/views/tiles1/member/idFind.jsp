...
<script type="text/javascript">
	...
	function goIdFind() {
		...
		const queryString = $("form[name='idFindFrm']").serialize();
	    ...
	    <div style="width: 80%; margin: 7% auto;">
			...
			<div id="idFindDiv">
		        <form name="idFindFrm">
		            ...
		            <div class="info">
		                <input type="text" name="name" id="name" placeholder="성명" maxlength="20">
		                <input type="text" name="phone" id="phone" placeholder="휴대폰 번호 ('-' 제외 11자리 입력)" maxlength="11">
		            </div>
